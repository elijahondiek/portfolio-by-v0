        ...
        <div className="flex flex-wrap justify-center mb-8 gap-2">
          <button
            ...
            className={cn(
              ...
              activeTab === "current" ? "text-[#0a0f1c]" : "glass-card hover:text-[#00d4ff]",
            )}
            style={activeTab === "current" ? { backgroundImage: "linear-gradient(to right, #00d4ff, #00ff88)" } : {}}
          >
          ...
          <button
            ...
            className={cn(
              "flex items-center space-x-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:scale-105",
              activeTab === "previous" ? "text-[#0a0f1c]" : "glass-card hover:text-[#00d4ff]",
            )}
            style={activeTab === "previous" ? { backgroundImage: "linear-gradient(to right, #00d4ff, #00ff88)" } : {}}
          >
          ...
          <button
            ...
            className={cn(
              "flex items-center space-x-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:scale-105",
              activeTab === "achievements" ? "text-[#0a0f1c]" : "glass-card hover:text-[#00d4ff]",
            )}
            style={
              activeTab === "achievements" ? { backgroundImage: "linear-gradient(to right, #00d4ff, #00ff88)" } : {}
            }
          >
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {achievements.map((achievement, index) => (
                <div
                  key={achievement.id}
                  className={`glass-card p-6 transform transition-all duration-1000 hover:scale-105 ${
                    isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
                  }`}
                  style={{
                    transitionDelay: `${0.4 + index * 0.1}s`,
